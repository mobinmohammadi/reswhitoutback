    ...
    <>
      ...
      >
        <div>
          ...
          <div className="flex flex-col mt-3 gap-3 h-[450px] overflow-y-scroll">
            {arrayUserBasket?.map((item) => (
              <>
                {console.log(item)}
                <div key={item.id} className="flex gap-2 border-b-1 border-[#dddddd] pb-3">
                  <img className="w-30 h-20 object-cover rounded-sm" src={item.image_url} alt="" />
